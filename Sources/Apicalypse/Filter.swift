...
public struct Filter: CustomStringConvertible {
    ...
    /// <# Description #>
    public init<Entity, Value>(field keyPath: KeyPath<Entity, Value>, operator: Operator, value: Value) throws where Entity: Composable {
        try self.init(property: Entity.codingPath(for: keyPath), operator: `operator`, value: String(describing: value))
    }

    /// <# Description #>
    public init<Entity, Value>(field keyPath: KeyPath<Entity, Value?>, operator: Operator, value: Value?) throws where Entity: Composable {
        try self.init(property: Entity.codingPath(for: keyPath), operator: `operator`, value: value.map(String.init(describing:)))
    }
    ...
    public init<Entity, Value>(field keyPath: KeyPath<Entity, Value>, operator: Operator, values: Value)
        throws where Entity: Composable, Value: Collection {
            try self.init(property: Entity.codingPath(for: keyPath), operator: `operator`,
...
public func > <Entity, Value>(lhs: KeyPath<Entity, Value>, rhs: Value) throws -> Filter where Entity: Composable, Value: Numeric {
...
public func == <Entity, Value>(lhs: KeyPath<Entity, Value>, rhs: Value) throws -> Filter where Entity: Composable, Value: Collection {
